...
> = {
  en: {
    ...
    sub: '9 captions + 3 graphics ready for Facebook, Instagram, and LinkedIn. Free, no signup.',
  ...
  es: {
    ...
    sub: '9 textos + 3 gráficos listos para Facebook, Instagram y LinkedIn. Gratis, sin registro.',
  ...
  pl: {
    ...
    sub: '9 tekstów + 3 grafiki gotowe na Facebook, Instagram i LinkedIn. Bezpłatnie, bez rejestracji.',
  ...
  pt: {
    ...
    sub: '9 textos + 3 gráficos prontos para Facebook, Instagram e LinkedIn. Grátis, sem registo.',
  ...
  de: {
    ...
    sub: '9 Anzeigentexte + 3 Grafiken für Facebook, Instagram und LinkedIn. Kostenlos, ohne Anmeldung.',
  ...
  fr: {
    ...
    sub: '9 textes + 3 visuels prêts pour Facebook, Instagram et LinkedIn. Gratuit, sans inscription.',
  ...
  it: {
    ...
    sub: '9 testi + 3 grafiche pronti per Facebook, Instagram e LinkedIn. Gratis, senza registrazione.',
