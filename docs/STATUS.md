...
| 5 | **Cost alerting on `ai_generation_log`** — if daily cost crosses $50 OR avg-per-audit crosses $1, email the operator. Sits on top of the admin dashboard data we already have. | Catches Anthropic invoice surprises before they happen; complements the `/admin/audit-costs` page. | S | Me |
