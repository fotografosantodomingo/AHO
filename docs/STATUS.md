...
| 5 | **Drift cron for Instagram** (Phase 3 of `docs/INSTAGRAM_SHARING_PLAN.md`) — daily poll of each agent's `/me/accounts`, email anyone who newly linked an IG Business to a Page so they can click Reconnect to enable IG publishing. | After Meta BV lands + soft-beta agents are added, this is the friction-removal step for "I linked IG yesterday but AHO doesn't know yet." | S | Me |
